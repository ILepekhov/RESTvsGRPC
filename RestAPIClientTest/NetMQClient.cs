...
namespace RestAPIClientTest
{
    public sealed class NetMQClient : IDisposable
    {
        ...
        public async Task<List<MeteoriteLanding>> GetLargePayloadAsyncMultipart()
        {
            return await Task.Run(() =>
            {
                var items = new List<MeteoriteLanding>();
        ...
        public async Task<string> PostLargePayloadAsyncMultipart(List<MeteoriteLanding> grpcMeteoriteLandings)
        {
            return await Task.Run(() =>
            {
